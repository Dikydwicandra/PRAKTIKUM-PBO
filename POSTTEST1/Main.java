...
public static void lihatdata() throws IOException{
    ...
    for (int i = 0; i<data.size(); i++){
        ...
        System.out.println(" Nama Handphone   : "+ data.get(i).nama);
        System.out.println(" Warna Handphone  : "+ data.get(i).warna);
        System.out.println(" Kapasitas Memory : "+ data.get(i).kapasitas+" GB");
        System.out.println(" Harga Handphone  : "+ data.get(i).harga);
        System.out.println("==========================");
        System.out.print("\n");
        }
    }
...
public static void ubahdata() throws IOException {
    ...
    System.out.println("============================");
    data.get(index-1).nama= setNama;
    data.get(index-1).warna= setWarna;
    data.get(index-1).kapasitas = setKapasitas;
    data.get(index-1).harga = setHarga;
